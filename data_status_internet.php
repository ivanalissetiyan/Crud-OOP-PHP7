...
<body id="page-top">
    ...
    <div class="content-wrapper py-3">
        ...
        <!-- Breadcrumbs -->
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Data Status Internet</li>
            </ol>
            <button onClick="tambahPelanggan()" style="margin-bottom:10px;" class="btn btn-primary btn-xs">Tambah</button>
                        ...
                        <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['status_port'] ?></td>
    ...
    $(document).ready(function(){
        ...
        if (confirm("Sure want delete it ?") == true) {
            ...
            $.ajax({
            url : 'core/status_internet/deleteStatus.php',
            type: 'POST',
            data: {id:id_p},
            success:function(data){
                alert('success delete status internet');
                window.location.href='data_status_internet.php';    
                } 
            });                        
            } else {
        ...
        //alert(id_user);
            $.ajax({
                url: 'core/status_internet/editStatus.php',
                type: 'GET',
                data: {id:id_p},
                success:function(data){
        ...
        $('#btnExport').click(function(){
            ...
            var filename = 'Data Status Internet'
            var downloadLink;
    ...
    {
        window.location="tambah_status.php";
    }
    </script>
