...
$datanya = $conn->showData("data_kurikulum", "id");
...
<body id="page-top">
    ...
    <div class="content-wrapper py-3">
        ...
        <!-- Breadcrumbs -->
            ...
            <button onClick="tambahKurikulum()" style="margin-bottom:10px;" class="btn btn-primary btn-xs">Tambah</button>
    ...
    {
        window.location="tambah_kurikulum.php";
    }
    </script>
