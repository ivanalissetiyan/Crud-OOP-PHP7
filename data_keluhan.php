...
<body id="page-top">
    ...
    <div class="content-wrapper py-3">
        ...
        <!-- Breadcrumbs -->
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Data Keluhan Pelanggan</li>
            </ol>
            <button onClick="tambahKeluhan()" style="margin-bottom:10px;" class="btn btn-primary btn-xs">Tambah</button>
                        ...
                        <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['subject_p'] ?></td>
                                        <td><?php echo $row['nama'] ?></td>
                                        <td><?php echo $row['contact_person'] ?></td>
                                        <td><?php echo $row['no_pengaduan'] ?></td>
        ...
        <div class="modal" id="modalEdit">
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Edit Keluhan Pelanggan</h4>
    ...
    $(document).ready(function(){
        ...
        if (confirm("Sure want delete it ?") == true) {
            ...
            $.ajax({
            url : 'core/keluhan/deleteKeluhan.php',
            type: 'POST',
            data: {id:id_p},
            success:function(data){
                alert('success delete data keluhan');
        ...
        //alert(id_user);
            $.ajax({
                url: 'core/keluhan/editKeluhan.php',
                type: 'GET',
                data: {id:id_p},
                success:function(data){
        ...
        $('#btnExport').click(function(){
            ...
            var filename = 'Data Keluhan Pelanggan'
            var downloadLink;
    ...
    {
        window.location="tambah_keluhan.php";
    }
    </script>
