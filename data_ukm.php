                        ...
                        <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                            ...
                            while($row = mysqli_fetch_array($result)){
                                ...
                                <tr>
                                    ...
                                    <td><a href="" class="delete" data-id='<?php echo $row['id_ukm'] ?>' title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    &nbsp;
                                    <a href="" data-toggle="modal" data-target="#myModal" class="update" data-id='<?php echo $row['id_ukm'] ?>' title="Update"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>
                                    &nbsp;
                    ...
                    <script type="text/javascript">
                        $(document).ready(function(){
                            $('.delete').click(function(){
                                var id_ukm = $(this).data('id');

                                if (confirm("Sure want delete it ?") == true) {
                                            
                                    $.ajax({
                                        url : 'core/deleteUkm.php',
                                        type: 'POST',
                                        data: 'id_ukm='+id_ukm,
                                    ...
                                    alert('success delete the data');
                                    window.location='data_ukm.php';
