...
INSERT INTO `tb_data_pelanggan` VALUES (14, '', '', '', '', '', '', '', '', '', '', 'update');
...
CREATE TABLE `tb_tagihan_pelanggan`  (
  `id_taggihan_pelggan` int(3) NOT NULL AUTO_INCREMENT,
  ...
  `jam` time(3) NOT NULL,
  PRIMARY KEY (`id_taggihan_pelggan`) USING BTREE
